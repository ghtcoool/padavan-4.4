...
dl_adg() {
logger -t "AdGuardHome" "正在下载AdGuardHome..."
curl -k -s -o /tmp/AdGuardHome/AdGuardHome --connect-timeout 10 --retry 3 https://raw.githubusercontent.com/ghtcoool/AdGuardHome/main/AdGuardHome
